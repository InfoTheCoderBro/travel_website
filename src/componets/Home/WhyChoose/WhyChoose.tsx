...
<div className='w-[80%] mx-auto grid grid-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-center mt-20'>

    {/* Why Choose Card */}

<div data-aos="fade-up" data-aos-anchor-placement="top-center">
    <WhyChooseCard image="/images/c1.svg" title="Best Price Guranteed" />
</div>
